...
# from https://github.com/zsancc/hy2install
...
show_menu() {
    ...
    echo "------------------------"
    echo -e "${GREEN}1. 安装 Hysteria 2${NC}"
    echo -e "${GREEN}2. 更新 Hysteria 2${NC}"
    echo -e "${GREEN}3. 卸载 Hysteria 2${NC}"
    echo -e "${GREEN}4. 启动 Hysteria 2${NC}"
    echo -e "${GREEN}5. 停止 Hysteria 2${NC}"
    echo -e "${GREEN}6. 重启 Hysteria 2${NC}"
    echo -e "${GREEN}7. 查看运行状态${NC}"
    echo -e "${GREEN}8. 查看配置${NC}"
    echo -e "${GREEN}9. 修改配置${NC}"
    echo -e "${GREEN}10. 查看日志${NC}"
    echo -e "${GREEN}11. 查看分享链接${NC}"
    echo -e "${GREEN}12. 显示分享二维码${NC}"
